...
基于 [Bangumi Api](https://bangumi.github.io/api/) 构建的 [Bangumi](https://bgm.tv/) 第三方 Web 客户端，使用 Next.js 13 appDir 开发。
...
> **Note**
> 这是我学习 web 开发过程中的一个 side project，目标是把 bangumi api 能实现的功能都尽量试着用当前热门的技术实现一下。
